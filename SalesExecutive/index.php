...
if (isset($_POST['username']) and isset($_POST['password'])){
  ...
  $query = "SELECT * FROM `salesExecutive` WHERE name = '$user_name' and password = '$password'";
...
if ($count == 1){
   ...
   echo" <script> window.location.href='salesExecutiveDashboard.php'</script>";
...
<html>
  <head>
    ...
    <title>WeR4You-SalesExecutive-Login </title>
